...
getRepo : Cmd Msg
getRepo = Http.get
    { url = "https://api.github.com/users/laura2243/repos"
...
view model =
    ...
    div []
        ...
        , h2 [style "background-color" "lavender",style "padding-left" "3cm"] [ text "Experience" ]
        , eventCategoriesView
        , eventsView
        , h2 [style "padding-left" "3cm", style "background-color" "lavender"] [ text "My top repos" ]
        , reposView
        ]
